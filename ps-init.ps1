...
$psInitInstalled = Get-InstalledScript -Name "ps-init" -RequiredVersion $psInitTargetVersion -ErrorAction SilentlyContinue
write-host "PS-init version: $($psInitInstalled.version)" -f green
...
if($autoImport) {
    ...
    Write-Host "`nModule auto-import disabled. Remember to manually import modules from .\modules\" -f Yellow
}
