...
write-host "`nVerifying ps-init accessible" -f cyan
$psInitInstalled = Get-InstalledScript -Name "ps-init" -ErrorAction SilentlyContinue
...
write-host "`nRunning ps-init" -f cyan
